...
<body>
  ...
  <div class="contact-form">
    ...
    <form action="resource_data_store6.php" method="post" style="color: white">
    	<div>
            <tr>
    		<td>
    			<label>Name 1:</label>
    ...
    <br>
      ...
      <div>
        ...
        <tr>
    		<td>
    			<label>Information 6:</label>
    		</td>
    		<td>
    			<input type="text" name="info6">
    		</td>
    	</tr>
    </div>
